...
def seed_reviews():
    ...
    # user2 product4 reviews------------------------------------------------------------------
    # review id 2
    review_002 = Review(
        user_id=2,
        product_id=4,
        stars=4,
        title='Smart Home w/ Alexa + Intergrating Multiple Devices',
        review="I don't like using my phone for the Ring doorbell. This is how my journey began. I started researching and see this is a good hub for smart-home devices. I purchased 4 devices. I am still learning how to integrate everything but it's coming along!",
        created_at=datetime.now(),
        # updated_at=datetime.now(),
    )
